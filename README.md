...
如果您在使用过程中出现问题，那么建议您前往 [github](https://github.com/2moe/tmoe-linux/issues) 提交 issue,开发者很乐意帮您解决问题。
...
假设您安装了一个kali-rolling容器，并自定义容器名称为z。  
当您输入`t p k z`时，发现启动的是proot kali zsh容器，而不是proot kali z。  
