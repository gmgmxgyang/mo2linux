...
INSTALLDEBIANORDOWNLOADRECOVERYTARXZ() {
	if [ ! -d "${DebianCHROOT}" ]; then
		less -meQ <<-'EndOfFile'
						...
						Welcome to use this tool to create creative videos and share them on youtube. If you attach your video sharing url to the github issue of this script, the developer will like the video you shared. 👍
