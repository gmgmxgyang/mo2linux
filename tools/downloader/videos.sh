...
upgrade_video_download_tool() {
    ...
    sudo pip3 install pip -U -i https://mirrors.bfsu.edu.cn/pypi/web/simple 2>/dev/null
    sudo pip3 install you-get -U -i https://mirrors.bfsu.edu.cn/pypi/web/simple
    you-get -V
    sudo pip3 install youtube-dl -U -i https://mirrors.bfsu.edu.cn/pypi/web/simple
