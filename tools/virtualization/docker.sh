...
tmoe_docker_init() {
    ...
    #aria2c --console-log-level=warn --no-conf --allow-overwrite=true -d ${MOUNT_DOCKER_FOLDER} -o ".tmoe-linux-docker.sh" https://gitee.com/mo2/linux/raw/master/debian.sh
